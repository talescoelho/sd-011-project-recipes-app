...
describe(`75 - Implement the explore ingredients screen elements respecting the
attributes described in the prototype`, () => {
  it('It has the correct data-testids for the explore food by ingredients screen',
    async () => {
  ...
  it('It has the correct data-testids for the explore drinks by ingredients screen',
    async () => {
