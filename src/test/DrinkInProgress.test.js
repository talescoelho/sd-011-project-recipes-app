...
import DrinkInProgress from '../pages/bebidas/recipeId/in-progress';
...
describe('Testa a página de detalhes da receita', () => {
  it('Testa se o elemento de loading está na tela', () => {
    renderWithRouter(<DrinkInProgress match={ match } />, testHistory);
  ...
  it('Testa se os elementos corretos estão todos na tela', async () => {
    ...
    expect(ing0).toHaveTextContent('Hpnotiq :2 oz');
  ...
  it('Testa se o ingrediente é marcado com check ao clicar nele', async () => {
    ...
    expect(ing0Before.attributes.checked).toBeTruthy();
    ...
    expect(ing1.attributes.checked).toBeTruthy();
  });
